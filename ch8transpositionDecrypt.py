...
def decryptMessage(key, message):
    ...
    # using a list of strings. First, we need to calculate a few
    # values.
    ...
    # Each string in plaintet represents a column in the grid:
    plaintext = [''] * numOfColumns

    # The column and row variables point to where in the grid the
    # next character in the encrypted message will go:
    column = 0
    row = 0
...
# If ch8transpositionDecrypt.py is run (instead of imported as a module),
